<%@page import="com.jkxy.web.model.Poets"%>
			...
			<div id="center">
				<div id="squeeze">
							...
							<div class="clear-block">
								<div id="node-2" class="node">
									<div class="content clear-block">
										...
										<%
										List<Poetries> poetrieList = (List<Poetries>)session.getAttribute("poetrieList");
										Iterator iter = poetrieList.iterator();
										Poetries poe = null;
										%>
											...
											<tr>
												<td class="AlternateRow" colspan="2"
													...
													style="padding-top:2px;text-align:left;float:left;FONT-SIZE: 16px">
														<%=poe.getTitle()%> </span></td>
											</tr>
											<tr>
												<td><span style="FONT-SIZE: 12px"> <a
														href="poeAction.action?selects=lbl_Author&keyword=<%= poe.getName()%>"><font
															color="blue">作者：<%=poe.getName()%></font>
					...
					<s:if test="#pager.hasFirst">
						<a href="poeAction.action?selects=lbl_Author&keyword=<%= poe.getName()%>&currentPage=1">首页</a>
					</s:if>
					<s:if test="#pager.hasPrevious">
						<a
							href="poeAction.action?selects=lbl_Author&keyword=<%= poe.getName()%>&currentPage=
					...
					<s:if test="#pager.hasLast">
						<a href="poeAction.action?selects=lbl_Author&keyword=<%= poe.getName()%>&currentPage=
