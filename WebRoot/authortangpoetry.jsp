							...
							<div class="clear-block">
								<div id="node-2" class="node">
									<div class="content clear-block">
										...
										<%
											List<Poets> poets = (List<Poets>)session.getAttribute("poets");
										...
										<tr <%if (i % 2 == 0) {%> bgcolor="#F0F8FF" <%}%>>
											<td><a href="poeAction.action?selects=lbl_Title&keyword=<%= poe.getTitle()%>&id=<%= poe.getPoet_id()%>">《<%= poe.getTitle()%>》</a></td>
										</tr>
										<%
											i++;
											}
